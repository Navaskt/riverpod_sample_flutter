...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( Joke joke)?  data,TResult Function( String message)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case _Loading() when loading != null:
return loading();case _Data() when data != null:
return data(_that.joke);case _Error() when error != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( Joke joke)  data,required TResult Function( String message)  error,}) {final _that = this;
switch (_that) {
case _Initial():
return initial();case _Loading():
return loading();case _Data():
return data(_that.joke);case _Error():
return error(_that.message);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( Joke joke)?  data,TResult? Function( String message)?  error,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case _Loading() when loading != null:
return loading();case _Data() when data != null:
...
class _Initial implements JokeState {
  const _Initial();
...
class _Loading implements JokeState {
  const _Loading();
...
class _Data implements JokeState {
  const _Data(this.joke);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Data&&(identical(other.joke, joke) || other.joke == joke));
}
...
/// @nodoc
abstract mixin class _$DataCopyWith<$Res> implements $JokeStateCopyWith<$Res> {
...
@pragma('vm:prefer-inline') $Res call({Object? joke = null,}) {
  return _then(_Data(
null == joke ? _self.joke : joke // ignore: cast_nullable_to_non_nullable
as Joke,
  ));
}
...
$JokeCopyWith<$Res> get joke {
  ...
  return $JokeCopyWith<$Res>(_self.joke, (value) {
    return _then(_self.copyWith(joke: value));
  });
}
}
...
class _Error implements JokeState {
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $JokeStateCopyWith<$Res> {
